export const i18n = {
    en: {
        ...
        worksBackHome: "← Home",
        worksExportPdf: "Export Portfolio",
        worksExportDemo: "Demo",
        worksExportHome: "Home Link",
        worksExportPortfolio: "Works Link",
        worksExportSource: "Source",
        worksExportTechStack: "Tech Stack",
        worksExportDocument: "Document",
        worksExportDesignDoc: "Design Doc",
        worksExportGenerated: "Exported",
        worksExportNote: "Interactive demos and source repositories are available online.",
        aboutTitle: "About Me",
    ...
    zh: {
        ...
        worksBackHome: "← 首页",
        worksExportPdf: "导出作品集",
        worksExportDemo: "演示",
        worksExportHome: "主页链接",
        worksExportPortfolio: "作品集链接",
        worksExportSource: "源码",
        worksExportTechStack: "技术栈",
        worksExportDocument: "说明书",
        worksExportDesignDoc: "设计书",
        worksExportGenerated: "导出时间",
        worksExportNote: "在线演示和源码仓库可通过线上作品集访问。",
        aboutTitle: "关于我",
