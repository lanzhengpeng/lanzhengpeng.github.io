export const i18n = {
    en: {
        ...
        navPub: "Publication",
        navWorks: "Works",
        worksEmpty: "No projects yet",
        worksEmptyHint: "Create a folder under public/works-data/ with meta.json and preview.html, then run npm run generate-works.",
        worksBackHome: "← Home",
        aboutTitle: "About Me",
    ...
    zh: {
        ...
        navWorks: "作品集",
        worksEmpty: "还没有作品",
        worksEmptyHint: "请在 public/works-data/ 目录下创建项目文件夹，每个文件夹包含 meta.json 和 preview.html，然后运行 npm run generate-works 生成清单。",
        worksBackHome: "← 首页",
        aboutTitle: "关于我",
